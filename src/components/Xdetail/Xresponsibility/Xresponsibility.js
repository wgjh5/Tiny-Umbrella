            ...
            <div className="box species">
                ...
                <div className="specielist nobt">
                    <div data-index="12050" className="content">
                        ...
                        <div className="specie_range">
                            <div className="range_item showdetail">
                                <div className="range_tit row">
                                    <p className="col">100种重大疾病

                                    </p>
                                    <span data-version="12050" data-index="0" className="range_detail">最高80万（5%复利递增10次）
                            ...
                            <div className="range_item">
                                <div className="range_tit row">
                                    ...
                                    <span data-version="12050" data-index="1" className="range_detail">18岁前额外赔付基本保额
                            ...
                            <div className="range_item">
                                <div className="range_tit row">
                                    ...
                                    <span data-version="12050" data-index="2" className="range_detail">重疾基本保额的30%
                            ...
                            <div className="range_item">
                                <div className="range_tit row">
                                    ...
                                    <span data-version="12050" data-index="3" className="range_detail">豁免未交保费
                ...
                <div className="specie_price row middle">
                    <div className="price col">
                        <p>
                            <span>￥
                                <span className="current">109</span>起</span>
